# LDNS_FOUND - true if library and headers were found
# LDNS_INCLUDE_DIRS - include directories
# LDNS_LIBRARIES - library directories
...
if(LDNS_FOUND)
    ...
    message(STATUS "Found LDNS: ${LDNS_INCLUDE_DIR}, ${LDNS_LIBRARY}")
else()
    message(FATAL_ERROR "LDNS library not found.")
endif()